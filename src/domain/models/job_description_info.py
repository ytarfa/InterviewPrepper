...
class Responsibility(BaseModel):
    category: str = Field(description="Category of responsibility (e.g., 'development', 'management', 'communication')")
...
class JobDescriptionInfo(BaseModel):
    ...
    seniority_level: str = Field(description="Seniority level (e.g., 'entry', 'mid', 'senior', 'lead', 'manager')")
    ...
    responsibilities: List[Responsibility] = Field(description="List of job responsibilities")
